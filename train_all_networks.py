...
if __name__ == '__main__':
    ...
    if train_env_config["graph"]["type"] == "regular":
        ...
        graph = nx.complete_graph(train_env_config["graph"]["num nodes"])

    elif train_env_config["graph"]["type"] == "min_max":
        num_nodes = train_env_config["graph"]["num nodes"]
        degree = train_env_config["graph"]["degree"] 
        min_max_name =  train_env_config["graph"]["min_max_name"]     
        
        path_read=train_env_config["graph"]["path_networks"] +"/DATA_social_networks_R/DATA_"+min_max_name+"/"
